...
import { Globe, Compass, Plus, MapPin, PieChart, Sparkles, Database, CheckCircle2, AlertCircle, User, RefreshCw } from "lucide-react";
      ...
      <header className="sticky top-0 z-50 border-b border-white/[0.08] bg-[#080C14]/90 px-4 py-3 backdrop-blur-xl sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto flex min-h-10 items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {/* User Pill */}
            {user && (
              <div className="hidden sm:flex items-center gap-2 px-2.5 py-1.5 rounded-xl bg-white/[0.04] border border-white/[0.08] text-xs">
                ...
                <span className="font-semibold text-slate-300">{user.firstName}</span>
              </div>
            )}
